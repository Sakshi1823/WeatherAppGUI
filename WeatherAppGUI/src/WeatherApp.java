...
public class WeatherApp {
    ...
    public static JSONObject getWeatherData (String locationName) {
        ...
        double longitude = (double) location.get("latitude");
...
//            System.out.println(resultJson);
    ...
    public static JSONArray getLocationData (String locationName) {
        // replace any whitespace in location name to + to adhere to AP's request format
//        locationName = locationName.replaceAll(regex: " ", replacement: "+");
    ...
    public static String getCurrentTime(){
        ...
        // format date to be 2024-08-02T00:00 (this is how it is read in the API)
